...
import { ColorAttributes } from '@iconify/tools/lib/colors/attribs.js';
import { ElementsTreeItem, AnalyseSVGStructureResult, ExtendedTagElement, AnalyseSVGStructureOptions } from '@iconify/tools/lib/svg/analyse/types.js';
